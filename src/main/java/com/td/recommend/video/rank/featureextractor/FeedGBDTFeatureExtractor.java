 ...
 */
public class FeedGBDTFeatureExtractor implements GBDTFeatureExtractor {
    private static final FeedGBDTFeatureExtractor instance = new FeedGBDTFeatureExtractor();

    public static FeedGBDTFeatureExtractor getInstance() {
        return instance;
    }

 ...
 */
public class TalentClusterRequestBuilder implements RequestBuilder<RetrieveKey, HttpRequest> {
    private static final String REQUET_URI = "/recall/talent_cluster";
    private static final Logger LOG = LoggerFactory.getLogger(com.td.recommend.requestbuilder.InterestRequestBuilder.class);
    private int num = 100;

    public TalentClusterRequestBuilder() {

    }

    public TalentClusterRequestBuilder(Config config) {

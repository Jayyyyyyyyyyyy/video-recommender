 ...
 */
public class BasicRequestBuilder implements RequestBuilder<RetrieveKey, HttpRequest> {
    private static final String URL = "/recall/basic";
    ...
    public BasicRequestBuilder(Config config) {

 ...
 */
public class HighCtrRequestBuilder implements RequestBuilder<RetrieveKey, HttpRequest> {
    private static final String URL = "/recall/jphighctr";

    private int num = 1000;

    public HighCtrRequestBuilder() {
    }

    public HighCtrRequestBuilder(Config config) {

 ...
 */
public class ClusterRequestBuilder implements HttpRequestBuilder<RetrieveKey> {
    private static final String REQUEST_URI = "/recall/cluster";

    private int num = 50;

    public ClusterRequestBuilder() {
    }

    public ClusterRequestBuilder(Config config) {

 ...
 */
public class ExploreUserRequestBuilder implements RequestBuilder<RetrieveKey, HttpRequest> {
    private static final String REQUET_URI = "/recall/eu";
    private static final Logger LOG = LoggerFactory.getLogger(com.td.recommend.requestbuilder.InterestRequestBuilder.class);
    private int num = 200;

    public ExploreUserRequestBuilder() {

    }

    public ExploreUserRequestBuilder(Config config) {

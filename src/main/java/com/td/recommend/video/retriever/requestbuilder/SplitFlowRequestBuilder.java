 ...
 */
public class SplitFlowRequestBuilder implements HttpRequestBuilder<RetrieveKey> {
    private static final String REQUEST_URI = "/recall/splitflow";

    private int num = 50;

    public SplitFlowRequestBuilder() {
    }

    public SplitFlowRequestBuilder(Config config) {

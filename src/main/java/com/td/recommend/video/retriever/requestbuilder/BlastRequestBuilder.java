...
/**
 * Created by zjl on 2020/2/6.
 */
public class BlastRequestBuilder implements RequestBuilder<RetrieveKey, HttpRequest> {
    private static final String URL = "/recall/blast";

    private int num = 100;

    public BlastRequestBuilder() {
    }

    public BlastRequestBuilder(Config config) {

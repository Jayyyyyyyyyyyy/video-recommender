...
public class RelevantGemRetrieveKeyBuilder implements RetrieveKeyBuilder {
  private VideoRecommenderContext recommendContext;
  private static final int MAX_COUNT = 50;
  private static final int MAX_ELAPSED_SECONDS = 60 * 60 * 6;

  public RelevantGemRetrieveKeyBuilder(VideoRecommenderContext recommendContext) {
  ...
  public void build(UserItem userItem, RetrieveKeyContext retrieveKeyContext) {
      ...
      retrieveKey.setType(RetrieverType.vgem_rlvt.name())
              .setAlias(RetrieverType.vgem_rlvt.alias())
              .setScore(1.0)
              .setKey(vid);

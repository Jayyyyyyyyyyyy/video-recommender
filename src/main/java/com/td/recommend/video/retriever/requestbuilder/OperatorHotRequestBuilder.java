...
public class OperatorHotRequestBuilder  implements RetrieveKeyHttpRequestBuilder {
    private static final String URI = "/recall/operatorhot";
    private int num = 10;

    private OperatorHotRequestBuilder() {
    }

    public OperatorHotRequestBuilder(Config config) {

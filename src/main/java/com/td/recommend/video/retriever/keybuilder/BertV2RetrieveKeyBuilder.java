...
public class BertV2RetrieveKeyBuilder implements RetrieveKeyBuilder {
    private VideoRecommenderContext recommendContext;
    private static final int MAX_COUNT = 50;
    private static final int MAX_ELAPSED_SECONDS = 60 * 60 * 6;

    public BertV2RetrieveKeyBuilder(VideoRecommenderContext recommendContext) {
    ...
    public void build(UserItem userItem, RetrieveKeyContext retrieveKeyContext) {
        ...
        for (String docId : candidates) {
            ...
            retrieveKey.setType(RetrieverType.vbert.name())
                    .setAlias(RetrieverType.vbert.alias())
                    .setScore(1.0)
                    .setKey(docId)

...
public class HotMp3RequestBuilder implements RequestBuilder<RetrieveKey, HttpRequest> {
    private static final String URL = "/recall/hotmp3";

    private int num = 200;

    public HotMp3RequestBuilder() {
    }

    public HotMp3RequestBuilder(Config config) {

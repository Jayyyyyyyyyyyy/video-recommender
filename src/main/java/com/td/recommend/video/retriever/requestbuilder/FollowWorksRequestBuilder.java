...
public class FollowWorksRequestBuilder implements RetrieveKeyHttpRequestBuilder {
  private static final String URI = "/recall/followworks";
  private int num = 10;

  private FollowWorksRequestBuilder() {
  }

  public FollowWorksRequestBuilder(Config config) {

...
import com.td.recommend.video.retriever.keybuilder.relevant.RelevantVideoRetrieveKeyBuilderFactory;
 ...
 */
public class RelevantRecommenderBuilder extends RecommenderBuilder<DocItem> {

    private int num = 550;

    public RelevantRecommenderBuilder(VideoRecommenderContext recommendContext) {
        super(recommendContext);
    }

    public RelevantRecommenderBuilder(VideoRecommenderContext recommendContext, int num) {
        super(recommendContext);
        this.num = num;
    }
    ...
    protected IRetrieveKeyBuilder buildRetrieveKeyBuilder() {
        ...
        return RelevantVideoRetrieveKeyBuilderFactory.getInstance().create(videoRecommendContext);
    }

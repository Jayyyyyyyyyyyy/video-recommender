...
import com.td.recommend.video.rank.predictor.FollowPredictor;
...
import com.td.recommend.video.retriever.keybuilder.follow.FollowRetrieveKeyBuilderFactory;
 ...
 */
public class FollowRecommenderBuilder extends RecommenderBuilder<DocItem> {

    private int num = 550;

    public FollowRecommenderBuilder(VideoRecommenderContext recommendContext) {
        super(recommendContext);
    }

    public FollowRecommenderBuilder(VideoRecommenderContext recommendContext, int num) {
        super(recommendContext);
        this.num = num;
    }
    ...
    protected IRetrieveKeyBuilder buildRetrieveKeyBuilder() {
        ...
        return FollowRetrieveKeyBuilderFactory.getInstance().create(videoRecommendContext);
